...
public class CompTest {
    ...
    public void testDelay() throws InterruptedException {
        ...
        CentralizedBidsPO centralizedBidsPO = CentralizedBidsPO.builder().stageId(stageId.toString()).bidPOs(bidPOs).build();
        Result<Void> result = unitFacade.submitCentralizedBidsPO(centralizedBidsPO);
        ...
        result = unitFacade.submitCentralizedBidsPO(centralizedBidsPO);
        Assertions.assertTrue(result.getSuccess());
